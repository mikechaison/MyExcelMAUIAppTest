...
public partial class LabCalculatorBaseListener : ILabCalculatorListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMaxExpr([NotNull] LabCalculatorParser.MaxExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMaxExpr([NotNull] LabCalculatorParser.MaxExprContext context) { }
